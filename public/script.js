...
(() => {
  const EN = {
    ...
    "w-one-small-moment-desc": "From a summer poolside into the night streets: Penny, Stella and Gav pass the song between them in a 1-minute-18-second one-take fisheye vertical MV. Built on the music and fisheye one-shot MV design by mankyu (@manaimovie), re-cast with the three of Penny's House. The title comes from the hook — \"One small moment, but it hit that way\".",
