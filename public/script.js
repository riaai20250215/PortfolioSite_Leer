...
(() => {
  const EN = {
    ...
    'process-lumia-desc': 'From contest requirements to music, fisheye porthole direction, keyframes, Seedance 2.0, Remotion typography, editing, and submission — a record of the decisions and failures behind the finished film.',
    'process-archive-copy': 'Production knowledge and creative preferences are archived across works.',
