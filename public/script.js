...
(() => {
  const EN = {
    ...
    "lnk-post": "View post →",
    "w-midnight-mart-badge": "Horror Special",
    "w-midnight-mart-meta": "2026 — HORROR SHORT (2 min)",
    "w-midnight-mart-desc": "A late-night supermarket: shelves fully stocked, machines humming, and not a single customer. At the register stand two clerks with exactly the same face. Found-footage horror told through the recording left on Gav's phone. A non-canon special of Penny's House — two minutes, no dialogue, no music.",
    "lnk-tiktok": "Watch on TikTok →",
    "w-one-small-moment-badge": "Vertical MV",
    ...
    "w-platform-badge": "Original Song",
